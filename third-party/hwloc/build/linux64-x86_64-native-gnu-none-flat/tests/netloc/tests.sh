...
export NETLOC_TESTS_PATH="/tmp/eronagha/chapel/third-party/hwloc/hwloc-src/tests/netloc"
export NETLOC_BUILD_PATH="/tmp/eronagha/chapel/third-party/hwloc/build/linux64-x86_64-native-gnu-none-flat/tests/netloc"
export NETLOC_UTIL_PATH="/tmp/eronagha/chapel/third-party/hwloc/build/linux64-x86_64-native-gnu-none-flat/utils/netloc"
